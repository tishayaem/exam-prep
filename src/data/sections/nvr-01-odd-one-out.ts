...
Tip: don't stare at the whole picture. Check **one feature at a time** across all five — "are they all the same colour? … the same size? … the same number of dots?" — and the odd one jumps out.`,
  ...
  questions: [
    ...
    },
    {
      ...
      sectionId: 'nvr-01-odd-one-out',
      type: 'nvr',
      prompt: 'Which star is the odd one out?',
      answer: '2',
      nvr: {
        kind: 'odd-one-out',
        stem: [
      ...
      explanation:
        'Four stars are white; one is grey. The shading gives it away.',
      difficulty: 1,
      source: 'GL NVR · Odd one out',
      variantOf: 'nvr-01-q1',
    },
    {
      ...
      explanation:
        'All striped — so shading is not the rule. Count the sides: four hexagons (6 sides) and one pentagon (5 sides).',
      difficulty: 1,
      source: 'GL NVR · Odd one out',
      variantOf: 'nvr-01-q1',
    },
    {
      ...
      explanation:
        'The shapes all differ, so look at what they share: three dots each — except the square, which has only two.',
      difficulty: 2,
      source: 'GL NVR · Odd one out',
      variantOf: 'nvr-01-q5',
    },
    {
      ...
      nvr: {
        ...
        stem: [
          ...
          { shape: 'diamond', fill: 'black', size: 'lg' },
        ],
      },
      explanation:
        'Different shapes, same shading — so compare sizes. Four are large; the square is small.',
      difficulty: 2,
      source: 'GL NVR · Odd one out',
      variantOf: 'nvr-01-q4',
    },
    {
      ...
      nvr: {
        kind: 'odd-one-out',
        stem: [
          { shape: 'square', fill: 'striped', rotation: 45 },
          { shape: 'square', fill: 'striped', rotation: 45 },
          { shape: 'square', fill: 'striped', rotation: 45 },
      ...
      explanation:
        'Four squares balance on a corner (turned 45°); one sits flat on its side. The rotation is the rule.',
      difficulty: 2,
      source: 'GL NVR · Odd one out',
      variantOf: 'nvr-01-q3',
    },
    {
      ...
      nvr: {
        kind: 'odd-one-out',
        stem: [
          { shape: 'flag', fill: 'white', mirrored: true, rotation: 90 },
          { shape: 'flag', fill: 'white' },
          { shape: 'flag', fill: 'white', rotation: 90 },
          { shape: 'flag', fill: 'white', rotation: 180 },
          { shape: 'flag', fill: 'white', rotation: 270 },
        ],
      },
      explanation:
        'Four flags are the same flag at quarter turns. The first is a REFLECTED flag — turned as well, to disguise it. Follow the pennant: it points the wrong way round.',
      difficulty: 3,
      source: 'GL NVR · Odd one out (reflection)',
      variantOf: 'nvr-01-q7',
    },
    {
      ...
      explanation:
        'In four shapes the dots match the number of sides: triangle 3, square 4, pentagon 5, hexagon 6. The star\'s four dots match nothing about it.',
      difficulty: 3,
      source: 'GL NVR · Odd one out',
      variantOf: 'nvr-01-q2',
    },
